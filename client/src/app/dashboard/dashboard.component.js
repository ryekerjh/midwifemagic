...
var DashboardComponent = (function () {
    function DashboardComponent(router, midwifeService) {
        this.router = router;
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.midwifeService.getMidwives()
            .then(function (midwives) { return _this.midwives = midwives.slice(1, 5); });
    };
    DashboardComponent.prototype.gotoDetail = function (midwife) {
